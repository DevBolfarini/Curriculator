...
🛠️ Stack Tecnológica
Interface: Streamlit (UI Interativa e Dashboard de KPIs)
...
🏗️ Arquitetura Modular (Separation of Concerns)
O software foi projetado com uma arquitetura modular para garantir escalabilidade e fácil manutenção:
